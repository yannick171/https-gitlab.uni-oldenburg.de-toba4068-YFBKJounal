                ...
                <ul>
                    ...
                    <!--script>
                        ...
                        <form action="about.php" id="registerform" method="post">
                            ...
                            <select name="Anrede" type="text" class="form-control" id="Anrede" placeholder="--bitte auswählen---">
                            ...
                            <select name="Titel" type="text" class="form-control" id="Titel" placeholder="" >
                        ...
                        <input type="radio" name="kunde" value="Yes" id="yes" checked="checked" /> <label for="oui">Yes</label>
                                <input type="radio" name="kunde" value="No" id="no" /> <label for="non"/>No
