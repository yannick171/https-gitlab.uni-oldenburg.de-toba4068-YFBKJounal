...
<form id="toSubmitPw" method="post">
	...
	<form action="" method="post">
        ...
        <p>
            ...
            <input type="button" id="button2" value="H1" onclick="insertTag('<h1>','</h1>','infotextInput');" />
            <input type="button" id="button3" value="Links" onclick="insertTag('<a>','</a>','infotextInput');" />
            <input type="button" id="button4" value="H2" onclick="insertTag('<h2>','</h2>','infotextInput');"/>
