    ...
    <div class="defaultstyle">
        <main class="">
            <div class="wrapper">
                ...
                <div class="box-2">
                    <h2>sharing is caring!</h2> Hier findet ihr eine Plattform zur veröffentlichung eurer Artikel, egal
                ...
                <div class="box-4">
                    ...
                    The relationship between habitat use by voles (Rodentia: Microtus) and the density of vegetative
                    cover was
                    studied to determine if voles select forage areas at the microhabitat level. Using live traps, I
                    trapped,
                    powdered, and released voles at 10 sites. At each trap site I analyzed the type and height of the
                    vegetation
                    in the immediate area. Using a black light, I followed the trails left by powdered voles through the
                    vegetation. I mapped the trails using a compass to ascertain the tortuosity, or amount the trail
                    twisted and turned, and visually checked the trails to determine obstruction of the movement path by
                    vegetation. I also checked vegetative obstruction on 4 random paths near the actual trail, to
                    compare the cover on the trail with other nearby alternative pathways. There was not a statistically
                    significant difference between the amount of cover on a vole trail and the cover off to the sides of
                    the trail when
                    completely covered; there was a significant difference between on and off the trail when the path
                    was completely
                    open. These results indicate that voles are selectively avoiding bare areas, while not choosing
                    among dense patches
                    ...
                    <div id="accordion">
                        <div class="card">
                            ...
                            <div id="collapseOne" class="collapse" aria-labelledby="headingOne"
                                ...
                                <div class="card-body">
                                    ...
                                    und mein Team neue Erkenntnisse im Bereich der Fuzzy-Logik gewinnen. Welche dies
                                    genau sind,
                                    können Sie in <a href="ressources/archivseite/Zeitung1/Fuzzy-Logik.txt">folgendem
                                        Artikel </a>lesen.
                                </div>
                            </div>
                        </div>
                        <div class="card">
                            ...
                            <div id="collapseTwo" class="collapse" aria-labelledby="headingTwo"
                                 data-parent="#accordion">
                                <div class="card-body">
                                    Dieses Paper widmet sich der Frage nach dem Verständnis der temporalen Logik. Der
                                    Schlüsssel
                                    unserer Forschung ist die Annahme, dass das Wichtigste bei dieser Diziplin das Tempo
                                    ist.Wie genau
                                    das Tempo maßgeblich für das Verstehen der temporalen Logik ist,
                                    können Sie in <a href="ressources/archivseite/Zeitung1/temporale-Logik.txt">folgendem
                                        Artikel </a>lesen.
                                </div>
                            </div>
                        </div>
                        <div class="card">
                            ...
                            <div id="collapseThree" class="collapse" aria-labelledby="headingThree"
                                 data-parent="#accordion">
                                <div class="card-body">
                                    In diesem Paper geht es darum, wie Forscher Edward Schneitzel mit seinen
                                    Mitarbeitern des renormierten Instituts Berkely für angewandte
                                    Neurolinguistik es geschafft hat einer KI das Dichten wie Shakespeare innnerhalb
                                    weniger Stunden anzutrainieren. Es wurde dafür eine
