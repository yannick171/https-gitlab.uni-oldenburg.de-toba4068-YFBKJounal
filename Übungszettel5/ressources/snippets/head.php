...
<div class="login">
    <ul>
        <li class="nav-item">
            <button style="background:transparent; color:white;" type="button" class="btn"
                    onclick="location.href='registration.php'" id="bigfont">
                <i class="material-icons">exit_to_app</i> Registrieren
            </button>
        </li>
        <li class="nav-item">
            <button style="background:transparent; color:white;" type="button" class="btn" data-toggle="modal"
                    data-target="#loginModal" id="bigfont">
    ...
    <div class="collapse navbar-collapse defaultstyle" id="navbarSupportedContent">
        <ul style="" class="navbar-nav mr-auto">
            ...
            <li class="nav-item" id="Profil">
                <?php
                if (isset($_GET["role"])) {
                    $_SESSION["status"] = $_GET["role"];
                }
                if(isset($_SESSION["status"]) && strcmp($_SESSION["status"], "editor") == 0){
                    echo "<a class='nav-link' href='redakteur.php'>Administration</a>";
                }
                else if (isset($_SESSION["status"]) && strcmp($_SESSION["status"], "author") == 0) {
                    echo "<a class='nav-link' href='autor.php'>meine Beiträge</a>";
                }
        ...
        <ul class="navbar-nav ml-md-auto">
            <li style="" class="nav-item">
                <form class="form-inline my-2 my-sm-0">
                    <button style="background: transparent; color: white; float:right;" class="btn my-2 my-sm-0"
                            data-toggle="modal" data-target="#searchModal" type="button" aria-expanded="false"><i
            ...
            <form method="get" action=<?php $_SERVER['PHP_SELF']?>>
                ...
                <div class="modal-body">
                    ...
                    <select class="custom-select" name = "role">
                        <option selected>Wählen Sie ihre Rolle als Benutzer der Website</option>
